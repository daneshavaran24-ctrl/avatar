...
#
# DO NOT DELETE THIS FILE. liara.json says `platform: node`, which reads as if
# this image were unused — it is not. Liara builds the app from this Dockerfile,
# and removing it fails the deploy with:
#   (HTTP code 400) the Dockerfile (Dockerfile) cannot be empty
